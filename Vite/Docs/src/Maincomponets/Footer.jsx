...
const Footer = () => {
    return (
        <div className='w-full h-screen py-30 px-20 flex'>
            <div className="w-1/2 h-full flex flex-col justify-between font-['anton'] text-[#212121] text-[9rem]  leading-none uppercase">
            ...
            <div className="w-1/2 h-full font-['anton'] text-[#212121] text-[9rem]  leading-none uppercase">
                <h1>presentations</h1>
                <div className="s -mt-18 ">
                    <span className="font-['Neue_Montreal'] text-xl mt-10">S:</span>
                    {["Instagram", "Behance", "Facebook", "Linkedin"].map((item, idx) => (

                        <span class=" relative font-['Neue_Montreal'] block font-light text-xl text-black py-1">
                ...
                <div className="s -mt-18 ">
                    <span className="font-['Neue_Montreal'] text-xl mt-10">L:</span>
                ...
                <div className="s -mt-18 ">
                    <span className="font-['Neue_Montreal'] text-xl mt-10">M:</span>
                    {["Home", "Services", "Our work", "About us", "Insights","Contact us"].map((item, idx) => (
                ...
                <div className="s -mt-18 ">
                    <span className="font-['Neue_Montreal'] text-xl mt-10">E:</span>
                       <span class=" relative font-['Neue_Montreal'] block font-light text-xl text-black py-1">
                            <span class="  relative inline-block before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-0 before:h-[3px] before:bg-zinc-700 before:transition-all before:duration-500 hover:before:w-full">
                                hello@ochi.design
                            </span>
